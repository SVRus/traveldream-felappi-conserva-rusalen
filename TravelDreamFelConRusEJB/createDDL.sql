...
CREATE TABLE CUSTOMIZEDTRAVELPACKAGE (IDTRAVELPACKAGE BIGINT NOT NULL, CUSTOMIZER_USERNAME VARCHAR(255), idcustomer VARCHAR(255), PRIMARY KEY (IDTRAVELPACKAGE))
CREATE TABLE EMPLOYEE (USERNAME VARCHAR(255) NOT NULL, code BIGINT, PRIMARY KEY (USERNAME))
CREATE TABLE PRODUCT (IDPRODUCT BIGINT AUTO_INCREMENT NOT NULL, PRODUCT_TYPE VARCHAR(31), COST FLOAT, NAME VARCHAR(255), TIMEEND DATETIME, TIMESTART DATETIME, idemployee VARCHAR(255), idtravelpackage BIGINT, PRIMARY KEY (IDPRODUCT))
...
ALTER TABLE CUSTOMIZEDTRAVELPACKAGE ADD CONSTRAINT FK_CUSTOMIZEDTRAVELPACKAGE_CUSTOMIZER_USERNAME FOREIGN KEY (CUSTOMIZER_USERNAME) REFERENCES REGISTEREDUSER (USERNAME)
