...
CREATE TABLE PRODUCT (IDPRODUCT BIGINT AUTO_INCREMENT NOT NULL, PRODUCT_TYPE VARCHAR(31), COST FLOAT, NAME VARCHAR(255), TIMEEND DATETIME, TIMESTART DATETIME, idtravelpackage BIGINT, employeeCreator VARCHAR(255), PRIMARY KEY (IDPRODUCT))
